...
import 'package:prayaas_loans/services/common/tg_log_level.dart';
import 'package:prayaas_loans/services/model/tg_flavor_vo.dart';
import 'package:prayaas_loans/services/util/tg_file_util.dart';

/// Environment Config
class TGEnvConfig {
  static const String ENV_FLAVOR = String.fromEnvironment('flavor');

//static const String ENV_FLAVOR = 'dev';
}
...
class TGFlavor {
  ...
  static void _loadCurrentFlavor() {
    ...
    if (_current != null) {
      ...
      if (_current!.applyMock == true) TGLog.i(" mockMappingsFile = " + _current!.mockMappingsFile.toString());
