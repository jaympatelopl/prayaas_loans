...
class TGMockService {
  ...
  static Future _saveMockMapping(TGMockMappingVO mockMappingVO) async {
    ...
    if (mockMappingVO.successFile != null)
      mockMappingVO.successString = await TGFileUtil.readFile(mockMappingVO.successFile!);
    if (mockMappingVO.errorFile != null)
      mockMappingVO.errorString = await TGFileUtil.readFile(mockMappingVO.errorFile!);
    _mockMappings[
